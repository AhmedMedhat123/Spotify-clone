        ...
        <>
            <div className="flex items-center justify-between">
                <div className="flex gap-2 items-center">
                    <FontAwesomeIcon onClick={()=>navigate(-1)} className='bg-black text-xl p-2 rounded-[100%] cursor-pointer' icon={faAngleLeft} />
                    <FontAwesomeIcon onClick={()=>navigate(1)} className='bg-black text-xl p-2 rounded-[100%] cursor-pointer' icon={faAngleRight} />
                </div>
