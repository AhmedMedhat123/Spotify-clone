    ...
    >
      ...
      <div className="flex flex-col gap-2.5">
        ...
        <input
          ...
          value={name}
          type="text"
          className="bg-transparent outline-green-500 border-2 border-gray-400 p2.5 w-[max(40vw,250px)]"
      ...
      <div className="flex flex-col gap-2.5">
        ...
        <input
          ...
          value={desc}
          type="text"
          className="bg-transparent outline-green-500 border-2 border-gray-400 p-3 w-[max(40vw,250px)]"
          placeholder="type here"
          required
        />
      </div>
      <div className="flex flex-col gap-2.5">
        ...
        <select
          ...
          defaultValue={album}
          className="bg-transparent outline-green-500 border-2 border-gray-400 p-2.5 w-[150px]"
        >
      ...
      <button
        type="submit"
        className="text-base bg-gray-800 text-white py-2.5 px-14 cursor-pointer "
      >
        Add
      </button>
    </form>
